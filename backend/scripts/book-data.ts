...
export const BOOK_DATA: BookDay[] = [
  ...
  // ============ 2 Mei (Sabtu) ============
  {
    ...
    transactions: [
      ...
      { raw: 'PAKET A (DADA B, TEH M), PAKET B (Paha)', amount: 105000, method: 'cash', orderType: 'dineIn', table: 4,
        items: [{ name: 'Paket A (1 org)', qty: 1, notes: 'Dada Bakar + Teh Manis' }, { name: 'Paket B (1 org)', qty: 1, notes: 'Paha' }] },
      { raw: 'Jeruk P, Krupuk', amount: 7000, method: 'cash', orderType: 'dineIn', table: 5,
  ...
  // ============ 4 Mei (Senin) ============
  {
    ...
    transactions: [
      { raw: '4 Ekor (BM/B), 14 Nasi, Susuk K', amount: 455000, method: 'qris', bank: 'BCA', orderType: 'dineIn', table: 9,
        items: [{ name: '1 Ekor Ayam Bakar Merah', qty: 4, notes: 'campur BM/B' }, { name: 'Nasi Putih', qty: 14 }, { name: 'Susu Kedelai', qty: 1 }] },
  ...
  // ============ 9 Mei (Sabtu) ============
  {
    ...
    transactions: [
      { raw: '2 Paket A (1 Paha B, 2 Dada G), 2 es teh', amount: 180000, method: 'qris', bank: 'BCA', orderType: 'dineIn', table: 8,
        items: [{ name: 'Paket A (1 org)', qty: 2, notes: 'Paha Bakar/Dada Goreng + Teh' }, { name: 'Teh Tawar Biasa', qty: 2, notes: 'penyesuaian' }] },
      { raw: '2 Krupuk, 1 Paket A (Dada B, Teh m), 1 Paket B, 1 Teh m', amount: 88000, method: 'cash', orderType: 'dineIn', table: 9,
        items: [{ name: 'Kerupuk', qty: 2 }, { name: 'Paket A (1 org)', qty: 1, notes: 'Dada Bakar + Teh Manis' }, { name: 'Paket B (1 org)', qty: 1 }, { name: 'Teh Manis Biasa', qty: 1 }] },
  ...
  // ============ 10 Mei (Minggu) ============
  {
    ...
    transactions: [
      ...
      { raw: '2 Paket B (1 Paha B, Dada G)', amount: 165000, method: 'qris', bank: 'BCA', orderType: 'dineIn', table: 6,
        items: [{ name: 'Paket B (1 org)', qty: 2, notes: 'Paha Bakar/Dada Goreng' }, { name: 'Udang Windu Bakar (isi 7)', qty: 0, notes: 'penyesuaian' }] },
  ...
  // ============ 15 Mei (Jumat) ============
  {
    ...
    transactions: [
      ...
      { raw: '1 Ekor, 1 Semur, 1 Gasem, 1 Gule, 1 Rawon, 1 Paha B', amount: 240000, method: 'transfer', bank: 'BCA', orderType: 'dineIn', table: 5,
        items: [{ name: '1 Ekor Ayam Bakar Merah', qty: 1 }, { name: 'Semur Daging', qty: 1 }, { name: 'Garang Asem Ayam', qty: 1 }, { name: 'Gulai Daging', qty: 1 }, { name: 'Rawon Daging', qty: 1 }, { name: 'Paha Ayam Bakar', qty: 1 }] },
  ...
  // ============ 19 Mei (Selasa) ============
  {
    ...
    transactions: [
      ...
      { raw: '1 Gurame, 1 Sayur Asem, 1 Nasi, 2 AM, 1 Pete, 1 Tahu Tempe G, 1 PAKET D (Empal P, Teh M)', amount: 167000, method: 'cash', orderType: 'dineIn', table: 3,
        items: [{ name: 'Gurame Bakar', qty: 1 }, { name: 'Sayur Asem', qty: 1 }, { name: 'Nasi Putih', qty: 1 }, { name: 'Air Mineral', qty: 2 }, { name: 'Petai Goreng', qty: 1 }, { name: 'Tahu Tempe Goreng', qty: 1 }, { name: 'Paket D (1 org)', qty: 1, notes: 'Empal + Teh Manis' }] },
      { raw: '1 PAKET B (DADA G), 1 Empal P, 1 Teh M, 1 Teh T', amount: 121000, method: 'qris', bank: 'BCA', orderType: 'dineIn', table: 4,
        items: [{ name: 'Paket B (1 org)', qty: 1, notes: 'Dada Goreng' }, { name: 'Empal Penyet', qty: 1 }, { name: 'Teh Manis Biasa', qty: 1 }, { name: 'Teh Tawar Biasa', qty: 1 }] },
  ...
  // ============ 21 Mei (Kamis) ============
  {
    ...
    summary: { transfer: 360000, cash: 217000, qris: 541000 },
  },
  // ============ 22 Mei (Jumat) ============
  {
  ...
  // ============ 27 Mei (Rabu) ============
  {
    ...
    transactions: [
      { raw: 'Udang W B, 1 Sayur Asem (Theo) ongkir 20.000', amount: 185000, method: 'transfer', bank: 'BCA', orderType: 'takeaway',
        items: [{ name: 'Udang Windu Bakar (isi 7)', qty: 1 }, { name: 'Sayur Asem', qty: 1 }, { name: 'Kerupuk Udang', qty: 1, notes: 'pesanan Theo + ongkir 20rb' }] },
    ],
