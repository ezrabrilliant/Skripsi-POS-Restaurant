...
| StarUML UC | ✅ 3 aktor (Kasir/Waiter/Owner) + 20 use case + UMLConstraint REV 2.3 note (kasir primary, waiter fallback) sudah lengkap di `Skripsi.mdj`. ⏳ REV 2.11 pending rebuild (19 UC: drop pembelian/opname-raw, +Kelola Modal/COGS). |
